...
public class ScrollSensitiveDemo {
    public static void main(String[] args) {
        try{
            ...
            //TYPE_SCROLL_SENSITIVE: Allows the cursor to move forward/backward and
            // reflects real-time changes from DB
            ...
            System.out.println("---------Fetch data is in live update mode----------");
